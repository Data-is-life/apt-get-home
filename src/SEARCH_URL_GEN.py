...
def search_url_part_three_gen(price):
    ...
    if price <= 49999:
        ...
        url = 'min-price=50k,max-price=125,'
    elif price <= 124999:
        url = 'min-price=75k,max-price=150,'
    elif price <= 149999:
        url = 'min-price=100k,max-price=175,'
    elif price <= 174999:
        url = 'min-price=125k,max-price=200,'
    elif price <= 199999:
        url = 'min-price=150k,max-price=225,'
    elif price <= 224999:
        url = 'min-price=175k,max-price=250,'
    elif price <= 249999:
        url = 'min-price=200k,max-price=275,'
    elif price <= 274999:
        url = 'min-price=225k,max-price=300,'
    elif price <= 299999:
        url = 'min-price=250k,max-price=325,'
    elif price <= 324999:
        url = 'min-price=275k,max-price=350,'
    elif price <= 349999:
        url = 'min-price=300k,max-price=375,'
    elif price <= 374999:
        url = 'min-price=325k,max-price=400,'
    elif price <= 399999:
        url = 'min-price=350k,max-price=425,'
    elif price <= 424999:
        url = 'min-price=375k,max-price=450,'
    elif price <= 449999:
        url = 'min-price=400k,max-price=475,'
    elif price <= 474999:
        url = 'min-price=425k,max-price=500,'
    elif price <= 499999:
        url = 'min-price=450k,max-price=550,'
    elif price <= 549999:
        url = 'min-price=500k,max-price=600,'
    elif price <= 599999:
        url = 'min-price=500k,max-price=650,'
    elif price <= 649999:
        url = 'min-price=550k,max-price=700,'
    elif price <= 699999:
        url = 'min-price=600k,max-price=750,'
    elif price <= 749999:
        url = 'min-price=650k,max-price=800,'
    elif price <= 799999:
        url = 'min-price=700k,max-price=850,'
    elif price <= 849999:
        url = 'min-price=750k,max-price=900,'
    elif price <= 899999:
        url = 'min-price=800k,max-price=950,'
    elif price <= 949999:
...
def search_url_part_eight_gen(lot_sqft):
    ...
    if lot_sqft <= 2000:
        url = 'max-lot-size=6.5k-sqf,'
    elif lot_sqft <= 4500:
        url = 'min-lot-size=2k-sqft,max-lot-size=6.5k-sqf,'
    elif lot_sqft <= 6500:
        url = 'min-lot-size=4.5k-sqft,max-lot-size=8k-sqf,'
    elif lot_sqft <= 8000:
